...
export const ArticleItem = (
  ...
  return (
    <article
      className={`article-item ${isStyleCard ? "style-card" : ""} ${isStyleRow ? "style-row" : ""} `}>
      ...
      <div className="article-item__content">
        ...
        {isShowButton ? buttonEle : null}

        {isShowIcon ? iconEle : null}
        ...
        {isShowDescription ? descriptionEle : null}

        <div className="article-item__info">
          
          {isShowAvatar ? avatarEle : null}
